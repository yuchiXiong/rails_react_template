...
const WrongPage: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen">
      ...
      <div className="mt-8 tracking-widest text-center">
        <span className="block mb-4 text-6xl text-gray-500">哦豁</span>
        <span className="text-xl text-gray-500 ">服务器菌坏掉了，程序员正在抢修中……</span>
      </div>
    </div>
  );
};
